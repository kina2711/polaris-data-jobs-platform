...
class AuditLogger:
    ...
    def _determine_task_type(self, task_id: str) -> str:
        ...
        if "bash" in task_id.lower() or "dbt" in task_id.lower():
            ...
            "post" in task_id.lower()
            or "discord" in task_id.lower()
            or "scrape" in task_id.lower()
            or "crawl" in task_id.lower()
            or "insert" in task_id.lower()
        ):
            return "python"
        else:
            return "python"

    def _determine_data_source(self, task_id: str) -> str | None:
    ...
    def _determine_layer(self, task_id: str) -> str | None:
